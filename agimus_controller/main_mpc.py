...
# Creating the scene
scene = Scene()
robot_simulator.pin_robot.collision_model, TARGET_POSE2, q0 = scene.create_scene(robot_simulator.pin_robot.model, robot_simulator.pin_robot.collision_model, "ball")
