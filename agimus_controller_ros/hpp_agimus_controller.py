...
class HppAgimusController:
    def __init__(self) -> None:
        ...
        robot_model, collision_model, visualization_model = pandawrapper.create_robot()
        ...
        mpc = MPC(ocp, x_plan, a_plan, robot_model, collision_model)
    ...
    def solve_and_send(self):
        ...
        self.control_msg.feedback_gain = to_multiarray_f64(self.mpc.ocp.solver.K[0])
        self.control_msg.feedforward = to_multiarray_f64(self.mpc.ocp.solver.us[0])
